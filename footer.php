        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    ...
                    <ul>
                        <li><?php _e('Address:','orjanik'); ?> <?php echo $options['footer-address']; ?></li>
                        <li><?php _e('Phone:','orjanik'); ?> <?php echo $options['footer-phone']; ?></li>
                        <li><?php _e('Email:','orjanik'); ?> <?php echo $options['footer-email']; ?></li>
                    </ul>
                </div>
            </div>
